        ...
        >
          <div className="h-[170px] w-full rounded-lg overflow-hidden relative">
            <Image
              ...
              sizes="max-w-full"
            />
            <div className="absolute opacity-0 rounded-lg hover:opacity-100 bg-primary-hover/10 inset-0 backdrop-blur-sm transition-all ease-linear duration-300 delay-0 cursor-pointer flex justify-center items-center w-full group">
